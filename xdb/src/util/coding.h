...
void PutLengthPrefixedSlice(std::string* dst, const Slice& input);
...
const char* DecodeVarint32(const char* dst,const char* limit, uint32_t* result);
const char* DecodeVarint64(const char* dst,const char* limit, uint64_t* result);
