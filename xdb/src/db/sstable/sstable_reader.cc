...
void SSTableReader::ReadFilter(const Slice& handle_contents) {
    Slice s = handle_contents;
...
Iterator* SSTableReader::ReadBlockHandle(void* arg, const ReadOption& option, const Slice& handle_contents) {
    SSTableReader* table = reinterpret_cast<SSTableReader*>(arg);
    BlockHandle handle;
    BlockReader* block = nullptr;
    BlockContents block_contents;
    Slice tmp = handle_contents;
